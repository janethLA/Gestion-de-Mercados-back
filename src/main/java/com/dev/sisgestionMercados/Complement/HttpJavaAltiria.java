...
public class HttpJavaAltiria {
	public static void main(String[] args) {
		...
		HttpPost post = new HttpPost("http://www.altiria.net/api/http");//https://www.altiria360.net/
		...
		parametersList.add(new BasicNameValuePair("login", "luna_jla99@hotmail.com"));
